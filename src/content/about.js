  ...
  ABOUT_ME: (age) => (
    <>
      <p>
        My name is
        {' '}
        <b>Will Paige</b>, I'm a {age}-year-old
        {' '}
      ...
      <p>
        ...
        My career trajectory has given me a unique skill set that allows me to have a rich UI/UX centered
        approach to programming and development.
      </p>
      <p>
